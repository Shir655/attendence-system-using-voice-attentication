	...
	submit.addEventListener("click", function (event) {
		...
		xhr.onload = function (e) {
			if (this.readyState === 4) {
				...
				if (action == 'register-attendance') {
					document.getElementById("result").innerText = 'Hey,' +username+ ' You have been registered!'+filename;
				} else {
					if (response === 'SUCCESS') {
					document.getElementById("result").innerText = 'Hey' +username+ 'Welcome, it is you!'+filename;
				} else {
